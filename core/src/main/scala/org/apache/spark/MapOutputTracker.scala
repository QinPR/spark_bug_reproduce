...
private class ShuffleStatus(numPartitions: Int) {
   ...
   */
  def addMapOutput(mapId: Int, status: MapStatus): Unit = withWriteLock {
   ...
   */
  def removeMapOutput(mapId: Int, bmAddress: BlockManagerId): Unit = withWriteLock {
